       ...
       <c:when test="${not empty cartLines }">
		...
		<c:forEach items="${cartLines}" var="cartLine">
		      ...
		      <tr>
				...
				<td data-th="Quantity">
				<input type="number" class="form-control text-center" id="count_${cartLine.id}" value="${cartLine.productCount }"></td>
				<td data-th="Subtotal" class="text-center">&#8377; ${cartLine.total }</td>
				
				<td class="actions" data-th="">
					<button type="button" type="refreshCart" value="${cartLine.id}" class="btn btn-info btn-sm">
